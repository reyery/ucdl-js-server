...
const { skyRays, rayLineIntersect, rayPgonIntersect, iDir, crossProduct, vectorSub, pointInPgon } = require("./util");
...
// -------------------------------------------------------------------------------------------------
const vecs = skyRays
console.log('tregenzaSky length:', vecs.length)
 ...
 * 
 */
function Sky(lines, pgons, buildings, sensors, gridSize, _, taskNum) {
